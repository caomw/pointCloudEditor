#ifndef _PCEFusionMesh
#define _PCEFusionMesh
...
public:
	...
	PCEFusionMesh (const PCEFusionMesh& other)
	{
		deepCopy(other);
	}
	PCEFusionMesh& operator = (const PCEFusionMesh& other)
	{
		deepCopy(other);
		return *this;
	}

	void deepCopy (const PCEFusionMesh& other)
	{
