...
PCEPreviewTextureToTargetGL::PCEPreviewTextureToTargetGL()
{
}
...
bool PCEPreviewTextureToTargetGL::renderTextureToTarget(MHWRender::MTexture* texture, MHWRender::MRenderTarget *target)
{
