...
const MString PCEPcdFileIOCmd::kPCDFileIOCmd = "pointCloudPcdFile";
...
/*static*/
void* PCEPcdFileIOCmd::creator()
{
	return new PCEPcdFileIOCmd;
}

MStatus PCEPcdFileIOCmd::doIt(const MArgList& args)
{
...
MStatus PCEPcdFileIOCmd::parseArgs( const MArgList& args)
{
