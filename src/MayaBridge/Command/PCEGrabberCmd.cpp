...
const MString PCEGrabberCmd::kGrabberCmd = "pointCloudGrabber";
...
/*static*/
void* PCEGrabberCmd::creator()
{
	return new PCEGrabberCmd;
}

MStatus PCEGrabberCmd::doIt(const MArgList& args)
{
...
MStatus PCEGrabberCmd::parseArgs( const MArgList& args)
{
...
/*static*/
MSyntax PCEGrabberCmd::newSyntax()
{
	MSyntax syntax;
