...
#ifndef POINTCLOUDTEXTURESHADEROVERRIDE_H
#define POINTCLOUDTEXTURESHADEROVERRIDE_H

#include <maya/MPxShaderOverride.h>
#include <maya/MShaderManager.h>


class pointCloudTextureShaderOverride : public MHWRender::MPxShaderOverride
{
public:
	pointCloudTextureShaderOverride(const MObject& obj);
	static MHWRender::MPxShaderOverride* Creator(const MObject& obj);

	virtual ~pointCloudTextureShaderOverride();
