#ifndef _PCEKinectFusion
#define _PCEKinectFusion
//
// Copyright (C) Tingzhu Zhou
// 
// File: PCEKinectFusion.h
//
// Author: Tingzhu Zhou
//
#include "../PCEDeviceCache.h"

#include <NuiKinectFusionApi.h>
#include <boost/thread/thread.hpp>

class PCEKinectFusion
{
...
public:
	...
	bool								readMesh(PCEFusionMesh* pMesh);
...
private:
	...
	PCEDeviceCache*						m_pCache;
	int									m_cachedFrameIndex;
